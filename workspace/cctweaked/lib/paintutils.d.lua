...
local paintutils = {
	...
	---@return number[][] image The parsed image data, suitable for use with paintutils.drawImage.
	...
	---@return number[][] image The parsed image data, suitable for use with paintutils.drawImage, or nil if the file does not exist.
	...
	drawLine = function(startX, startY, endX, endY, color) end,
	...
	drawBox = function(startX, startY, endX, endY, color) end,
	...
	---@param image number[][] The parsed image data.
