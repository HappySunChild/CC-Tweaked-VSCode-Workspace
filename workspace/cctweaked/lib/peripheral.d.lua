...
local peripheral = {
	...
	---@param peripheral string | cc.types.peripheral.WrappedPeripheral The name of the peripheral to find, or a wrapped peripheral instance.
	---@return string ... The peripheral's types, or `nil` if it is not present.
	getType = function(peripheral) end,

	---Get the name of a peripheral wrapped with `peripheral.wrap`.
	---@param peripheral cc.types.peripheral.WrappedPeripheral The peripheral to get the name of.
	---@return string name The name of the given peripheral.
	getName = function(peripheral) end,

	---Check if a peripheral is of a particular type.
	---@param peripheral string | cc.types.peripheral.WrappedPeripheral The name of the peripheral or a wrapped peripheral instance.
	...
	---@param filter? fun(name: string, wrapped: cc.types.peripheral.WrappedPeripheral): boolean A filter function, which takes the peripheral's name and wrapped table and returns if it should be included in the result.
	---@return cc.types.peripheral.WrappedPeripheral ... 0 or more wrapped peripherals matching the given filters.
