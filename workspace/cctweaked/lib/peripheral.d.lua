...
---@class cc.peripheral.InventoryItem
---@field name string
---@field count integer
---@field nbt string?

---@class cc.peripheral.DetailedInventoryItem : cc.peripheral.InventoryItem
...
---@class cc.peripheral.FluidTankInfo
---@field amount integer
---@field name string

---@alias cc.peripheral.Side
---| '"top"'
---| '"bottom"'
---| '"left"'
---| '"right"'
...
---@alias cc.peripheral.WrappedPeripheral any
...
local peripheral = {
	...
	---@param name cc.peripheral.Side|string The name of the peripheral to find.
	...
	---@param name cc.peripheral.Side|string The side or network name that you want to check.
	---@return boolean isPresent If a peripheral is present with the given name.
	isPresent = function(name) end,

	---Get the types of a named or wrapped peripheral.
	---@param peripheral string|cc.peripheral.WrappedPeripheral The name of the peripheral to find, or a wrapped peripheral instance.
	---@return string ... The peripheral's types, or `nil` if it is not present.
	getType = function(peripheral) end,

	---Get the name of a peripheral wrapped with `peripheral.wrap`.
	---@param peripheral cc.peripheral.WrappedPeripheral The peripheral to get the name of.
	---@return string name The name of the given peripheral.
	getName = function(peripheral) end,

	---Check if a peripheral is of a particular type.
	---@param peripheral string|cc.peripheral.WrappedPeripheral The name of the peripheral or a wrapped peripheral instance.
	...
	---@param name cc.peripheral.Side|string The name of the peripheral to wrap.
	---@return cc.peripheral.WrappedPeripheral wrappedPeripheral The table containing the peripheral's methods, or nil if there is no peripheral present with the given name.
	...
	---@param filter? fun(name: string, wrapped: cc.peripheral.WrappedPeripheral): boolean A filter function, which takes the peripheral's name and wrapped table and returns if it should be included in the result.
	---@return cc.peripheral.WrappedPeripheral ... 0 or more wrapped peripherals matching the given filters.
