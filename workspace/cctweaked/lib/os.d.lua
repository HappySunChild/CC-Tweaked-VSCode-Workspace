...
local os = {
	...
	---@param filter? string | cc.types.os.Event Event to filter for.
	---@return string | cc.types.os.Event event The name of the event that fired.
	...
	---@param filter? string | cc.types.os.RawEvent Event to filter for.
	---@return string | cc.types.os.RawEvent event The name of the event that fired.
	---@return any ... Optional additional parameters of the event.
	...
	---@param locale cc.types.os.Locale The locale of the time, or a table filled by os.date("*t") to decode. Defaults to `ingame` locale if not specified.
	...
	---@param locale cc.types.os.Locale The locale to get the day for. Defaults to `ingame` if not set.
	...
	---@param locale cc.types.os.Locale The locale to get the milliseconds for. Defaults to `ingame` if not set.
	...
	---@return string | cc.types.os.TimestampTable time The timestamp to convert to a string. This defaults to the current time.
