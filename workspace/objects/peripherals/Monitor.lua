...
---This allows them to be read and interacted with in-world without opening a GUI.
---@class peripheral.Monitor : term.Redirect
local Monitor = {}
...
function Monitor.getTextScale(scale) end
