...
---@class create.peripheral.Repackager
local Repackager = {
	---Gets the Repackager's address.
	---@return string
	getAddress = function() end,

	---Sets the Repackager's address to the given variable until it tries to make a package
	...
	---Activates the repackager like if it was powered by redstone. It operates by the same rule as
