...
---@alias plethora.peripheral.RedstoneIntegrator.Direction
---| '"north"'
---| '"east"'
---| '"south"'
---| '"west"'
...
local RedstoneIntegrator = {
	...
	---@return cc.peripheral.Side[]
	getSides = function() end,

	---Get the current redstone input of a specific direction.
	---@param direction plethora.peripheral.RedstoneIntegrator.Direction The direction to get.
	...
	---@param direction plethora.peripheral.RedstoneIntegrator.Direction The direction to set.
	...
	---@param direction plethora.peripheral.RedstoneIntegrator.Direction The direction to test.
