...
---@alias tom.peripheral.RedstonePort.Direction
---| '"north"'
---| '"east"'
---| '"south"'
---| '"west"'
...
local RedstonePort = {
	...
	---@param direction tom.peripheral.RedstonePort.Direction The direction to get.
	...
	---@param direction tom.peripheral.RedstonePort.Direction The direction to set.
	...
	---@param direction tom.peripheral.RedstonePort.Direction The direction to test.
