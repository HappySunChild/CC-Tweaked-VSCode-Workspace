...
local disk = {
	...
	---@param name string The name of the disk drive.
	---@return string? label The name of the current media, or `nil` if the drive is not present or empty.
	getLabel = function(name) end,

	---Set the label of the floppy disk or other media.
	---@param name string The name of the disk drive.
	---@param label string? The new label of the disk
	setLabel = function(name, label) end,

	---Check whether the current disk provides a mount.
	---This will return true for disks and computers, but not records.
	---@param name string The name of the disk drive.
	---@return boolean hasMount If the disk is present and provides a mount.
	hasData = function(name) end,

	---Find the directory name on the local computer where the contents of the current floppy disk (or other mount) can be found.
	---@param name string The name of the disk drive.
	---@return string? path The mount's directory, or `nil` if the drive does not contain a floppy or computer.
	getMountPath = function(name) end,
	...
	---@param name string The name of the disk drive.
	---@return boolean hasAudio If the disk is present and has audio saved on it.
	hasAudio = function(name) end,
	...
	getAudioTitle = function(name) end,
