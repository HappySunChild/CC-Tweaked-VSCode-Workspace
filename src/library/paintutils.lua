...
---@param color? colors.color The color of this pixel. This will be the current background color if not specified.
...
---@param color? colors.color The color of this line. This will be the current background color if not specified.
...
---@param color? colors.color The color of this box. This will be the current background color if not specified.
